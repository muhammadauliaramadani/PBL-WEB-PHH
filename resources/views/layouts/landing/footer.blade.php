      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="{{ route('berita-lainnya') }}">Berita</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-4 col-md-12">
          ...
          <div class="social-links d-flex">
            <a href="https://www.instagram.com/phhpolitani?igsh=enVoN2I0d3FuZ2s="><i class="bi bi-instagram"></i></a>
          </div>
        </div>
