...
@section('content')
<section id="profil" class="custom-profil-section services section m-0 pt-5">
    <div class="container custom-section-title pb-2" data-aos="fade-up">
        <div class="section-title">
                <h2>Profil</h2>
        </div>
    </div>
    <div class="container p-0 mt-0">
        <div class="row justify-content-center g-4 m-0 p-0">
            <div class="col-lg-10 col-md-12 mx-auto" data-aos="fade-up" data-aos-delay="100">
                <div class="custom-service-item position-relative">
                    <p class="text-center">
                    ...
                    <p class="text-center">
                        Pada tahun 2021 berdasarkan Peraturan Direktur Politeknik Pertanian Negeri Samarinda Nomor 2 Tahun 2021 tentang Pengembangan/Pendirian Jurusan Politeknik Pertanian Negeri Samarinda program studi Pengolahan Hasil Hutan (PHH) dan Rekayasa Kayu (RK) tergabung dalam Jurusan Teknologi Hasil Hutan.
                    </p>
                    <p class="text-center">
                        Seiring perkembangan Politani Samarinda, pada tahun 2023 program studi Pengolahan Hasil Hutan (PHH) tergabung dengan empat program studi lain yaitu Rekayasa Kayu (RK), Pengelolaan Hutan (PH), Pengelolaan Lingkungan (PL), dan Teknologi Rekayasa Pengendalian Pencemaran Lingkungan (TRPPL) dalam Jurusan Lingkungan dan Kehutanan Politeknik Pertanian Negeri Samarinda Peraturan Menteri Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia Nomor 50 Tahun 2023 tentang Organisasi dan Tata Kerja Politeknik Pertanian Negeri Samarinda.
                    </p>
                </div>
            </div>
        </div>
